...
const Footer = () => {
  return (
    <footer className="bg-white font-poppins px-0 lg:pl-12 lg:pr-26 pt-16 pb-0">
      <div className="bg-[#d27622] w-full rounded-none lg:rounded-t-[30px] px-8 md:px-12 pt-16 pb-10 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center lg:text-left">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <ul className="space-y-4 text-base text-[#f3e3d3]">
              <li>Who we are</li>
              <li>How it works</li>
              <li>COOK reviews</li>
            </ul>
        ...
        {/* HORIZONTAL LINE */}
        <div className="h-px bg-white/20 w-full my-16"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 text-center lg:text-left">
          ...
          <div className="flex flex-col items-center lg:items-start mb-12 lg:mb-0">
            ...
            <ul className="text-base text-[#f3e3d3] space-y-4">
          ...
          <div className="flex flex-col items-center lg:items-start mb-12 lg:mb-0">
            {/* ✅ FIXED: Terminal-la kaatuna conflict inga thaan. 
                text-lg and text-sm rendu irundhuchu. 
                Standard layout-kaaga text-sm md:text-lg nu breakpoint vechu split panniten. */}
            <h3 className="font-bold text-sm md:text-lg mb-2 uppercase tracking-widest text-[#f3e3d3]/60">USA</h3>
            <p className="text-base text-[#f3e3d3]">Your address goes there</p>
            <p className="text-base text-[#f3e3d3] mt-2">+0000000000</p>
          </div>
        ...
        {/* COPYRIGHT */}
        <div className="mt-20 text-center text-sm text-[#f3e3d3]">
          2023©
        </div>
      </div>
    </footer>
