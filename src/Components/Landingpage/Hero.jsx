  ...
  return (
    <div className="bg-lightBg min-h-screen font-poppins px-6 md:px-8 lg:pl-12 lg:pr-26 py-12">
        ...
        <div className="max-md:order-2 md:order-2 lg:order-1 md:text-center md:col-span-2 lg:col-span-1 lg:text-left max-md:mt-16">
          ...
          <h1 className="text-4xl md:text-5xl max-md:text-3xl font-bold leading-tight text-gray-900">
            ...
            <span className="block md:hidden">
              ...
              Cooking with{" "}
              <span className="text-[#D26622] font-bold font-[cursive] italic">
                Experts
              </span>{" "}
              <br />
              Worldwide
          ...
          <div className="flex gap-4 mt-6 max-md:flex-col max-md:items-center md:justify-center lg:justify-start">
            <button className="bg-[#D26622] text-white px-5 py-2 rounded-md text-sm font-medium shadow-sm max-md:w-full hover:bg-[#b8571c]">
              Find Your Tutor
            </button>

            <button className="border border-[#D26622] text-[#D26622] px-5 py-2 rounded-md text-sm font-medium max-md:w-full hover:bg-[#D26622]/10">
              Join Our Chefs
            </button>
          </div>
        </div>
        ...
        <div className="flex justify-center md:justify-center lg:justify-end max-md:order-1 md:order-1 lg:order-2 md:col-span-2 lg:col-span-1">
          <div className="relative">
            ...
            <div className="
              ...
              lg:hidden
              bg-white border border-[#D26622]/30 rounded-xl p-4 w-[220px] shadow-md
            ">
      ...
      <div className="px-28 md:px-4 lg:px-28 py-16 max-md:px-4">
        <div className="mt-16 relative border border-[#D26622]/30 rounded-xl bg-[#D26622]/10 py-8 max-md:py-6">
          
          {/* LEFT LINE */}
          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-8 h-[1px] bg-[#D26622]/40 max-md:hidden"></div>

          {/* RIGHT LINE */}
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-8 h-[1px] bg-[#D26622]/40 max-md:hidden"></div>

          <div className="px-12 max-md:px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 text-center gap-6">
              
              <div>
                <h2 className="text-[#D26622] text-3xl max-md:text-xl font-extrabold">100+</h2>
                <p className="text-gray-600 text-md max-md:text-xs mt-1">Talented Chefs</p>
              </div>

              <div>
                <h2 className="text-[#D26622] text-3xl max-md:text-xl font-extrabold">1000+</h2>
                <p className="text-gray-600 text-md max-md:text-xs mt-1">Students</p>
              </div>

              <div>
                <h2 className="text-[#D26622] text-3xl max-md:text-xl font-extrabold">4.8 ★</h2>
                <p className="text-gray-600 text-md max-md:text-xs mt-1">Rating</p>
              </div>

              <div>
                <h2 className="text-[#D26622] text-3xl max-md:text-xl font-extrabold">20+</h2>
